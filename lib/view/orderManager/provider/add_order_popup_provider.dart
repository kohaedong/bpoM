 ...
 * Last Modified: 2022-11-14 14:36:10
 * Author: bakbeom
 * Modified By: bakbeom
...
class AddOrderPopupProvider extends ChangeNotifier {
  ...
  Future<bool> initData(Map<String, dynamic> bodyMapp,
    ...
    if (editModell != null &&
      ...
      try {
        quantity =
            priceModell.kwmeng != 0.0 ? '${priceModell.kwmeng!.toInt()}' : null;
        surcharge =
            editModell.zfreeQtyIn != 0.0 ? '${editModell.zfreeQtyIn}' : null;
      } catch (e) {
        pr(e);
      }
      pr('@!@!@!@!@!@!@!@!@$surcharge');
  ...
  void setQuantity(String? str, {bool? isNotNotifier}) {
    quantity = str;
    priceModel = null;
    if (str == null || str.isEmpty || priceModel == null) {
  ...
  Future<RecentOrderTItemModel> createOrderItemModel() async {
    ...
    temp.zfreeQtyIn = surcharge != null ? double.parse(surcharge!) : 0.0;
