...
TlistSearchOrderModel _$TlistSearchOrderModelFromJson(
    ...
    TlistSearchOrderModel(
      ...
      json['MWSBP'] as double?,
      json['NETPR'] as double?,
      json['NETWR'] as double?,
      ...
      json['ZDIS_PRICE'] as double?,
      json['ZDIS_RATE'] as double?,
      json['ZFREE'] as String?,
      json['ZFREE_QTY'] as double?,
      json['ZMESSAGE'] as String?,
      json['ZNETPR'] as double?,
