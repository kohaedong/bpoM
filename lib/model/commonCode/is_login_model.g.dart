...
IsLoginModel _$IsLoginModelFromJson(Map<String, dynamic> json) => IsLoginModel(
      ...
      json['XTM'] as String?,
      json['IKENID'] as String?,
      json['KUNAG'] as String?,
      json['SPART'] as String?,
      json['VTWEG'] as String?,
      json['XBATCH'] as String?,
      json['XCUSTINFO'] as String?,
      json['XEXPORT'] as String?,
      json['XKKBER'] as String?,
      json['XPLANT'] as String?,
    );
...
Map<String, dynamic> _$IsLoginModelToJson(IsLoginModel instance) =>
    <String, dynamic>{
      ...
      'KUNAG': instance.kunag,
      'SPART': instance.spart,
      'VTWEG': instance.vtweg,
      'XBATCH': instance.xbatch,
      'XCUSTINFO': instance.xcustinfo,
      'XEXPORT': instance.xexport,
      'XKKBER': instance.xkkber,
      'XPLANT': instance.xplant,
